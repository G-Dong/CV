...
if __name__ =='__main__':
 ...
 #   print(np.shape(second_rect))
   #print min_index_for_second_level
    real_start_point = min_index_for_first_level + min_index_for_second_level
    print np.shape(min_index_for_second_level)
    print np.shape(min_index_for_first_level)

   # print min_index_for_first_level[0, :]
    #print min_index_for_second_level[0, :]
    print np.shape(real_start_point) # since here it is right
    #print real_start_point
   # middel_point = [real_start_point[0] + find_the_median_point_of_rect(second_rect)[0], real_start_point[1] + find_the_median_point_of_rect(second_rect)[1]]
